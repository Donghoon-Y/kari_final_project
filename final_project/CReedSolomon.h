...
public:
	...
	void	init( int BitsPerSymbol, int CorrectableErrors, int mo, int poa,
...
public:
	...
	void Report( unsigned long& numOfCorrErr, unsigned long& numOfUncorrErr, unsigned long& numOfErrSymbol, float& byteErrRatioEst, unsigned int& numOfFillFrame );
...
private:
    ...
    static unsigned char GF256[255];
	static unsigned char GF256d[255]; // the golais feild tables for n=8
};
